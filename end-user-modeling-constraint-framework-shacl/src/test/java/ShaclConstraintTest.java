...
public class ShaclConstraintTest {
    ...
    private ShaclConstraintData dataGraph;
    ...
    public void forAll() {
        ...
        constraint.getTargetInstance(JOHN_UUID);
        ...
        invalidConstraint.getTargetInstance(JOHN_UUID);
    ...
    public void forNone() {
        ...
        trueConstraint.getTargetInstance(JOHN_UUID);
        ...
        falseConstraint.getTargetInstance(JOHN_UUID);
    ...
    public void forExactly() {
        ShaclConstraintShape constraint = new ShaclConstraintShape();
        constraint.getTargetInstance(PROJECT_UUID);
    ...
    public void unique() {
        ShaclConstraintShape constraint = new ShaclConstraintShape();
        constraint.getTargetInstance(SPRINT_UUID);
